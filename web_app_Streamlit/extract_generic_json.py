...
def process_file(input_folder, input_path, output_folder, model_type):
    try:
        ...
        specifications = client.chat.completions.create(
            model=model,
            messages=[
                {"role": "system", "content": "Categorize & extract 3D printer specifications key info from a factsheet, such as manufacturer, model, and materials, etc.:"},
